...
{
    public class GenericServiceAdmnistracion<T> : IGenericServiceAdministracion<T> where T : class
    {
        private readonly IGenericRepositoryAdministracion<T> _genericRepository;
        //private ISgPersonaRepository sgPersonaRepository;

        public GenericServiceAdmnistracion(IGenericRepositoryAdministracion<T> genericRepository)
        {
            _genericRepository = genericRepository;
        }

        //public GenericService(ISgPersonaRepository sgPersonaRepository)
        //{
        //    this.sgPersonaRepository = sgPersonaRepository;
        //}
